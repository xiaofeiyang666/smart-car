...
void main(void)
{
    ...
    control_init(); 
    fan_init();
		//wireless_uart_init(); 2026.4.14注释这里
    ...
    while (1)
    {
        ...
        {
            print_flag = 0;
            //sprintf(debug_str, "%d,%d,%d\n", target_speed_base, left_speed, right_speed);2026.4.14注释这里
            //wireless_uart_send_string(debug_str);2026.4.14注释这里
        }
    }
}
