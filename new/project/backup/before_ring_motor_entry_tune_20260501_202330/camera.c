...
#define CAMERA_RING_FIRST_MOUTH_MIN_FRAMES 10
#define CAMERA_RING_FIRST_MOUTH_GAP_FRAMES 2
#define CAMERA_RING_ENTRY_ARM_FRAMES     70
// 环岛偏置：远端入口触发后就开始给方向；若进环后切太狠就减小MAX或PREVIEW_BIAS。
#define CAMERA_RING_MID_BIAS_MIN         8
#define CAMERA_RING_MID_BIAS_MAX         20
#define CAMERA_RING_PREVIEW_BIAS         16
