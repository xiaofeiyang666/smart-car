...
#define KP_MUL_MID                       0.98f
#define KP_MUL_LARGE                     1.36f

#define KD_MUL_SMALL                     1.26f
#define KD_MUL_MID                       1.00f
#define KD_MUL_LARGE                     0.78f

#define STEP_SMALL                       1.10f
#define STEP_MID                         4.40f
#define STEP_LARGE                       10.50f
#define STEP_MIN                         0.60f

#define STEP_REVERSE_DPV_TH              1.00f
#define STEP_REVERSE_MUL                 1.65f
...
#define PREVIEW_LPF_ALPHA                0.68f
#define GYRO_LPF_ALPHA                   0.30f
#define ERRD_LPF_ALPHA                   0.40f
#define STEER_RAW_ALPHA_STRAIGHT         0.22f
#define STEER_RAW_ALPHA_CURVE            0.88f

#define STEER_FF_DPREVIEW_K              0.26f
#define STEER_FF_LIMIT_BASE              2.8f
#define STEER_FF_LIMIT_CURVE_ADD         3.2f
...
#define DUAL_PD_HEAD_P_CURVE_ADD         0.70f  // 弯道时前瞻P增强
#define DUAL_PD_HEAD_D_GAIN              0.90f  // 前瞻D权重（控制S弯切换速度）
#define DUAL_PD_GYRO_D_CURVE_KEEP        0.42f  // 弯中保留的陀螺阻尼比例，越小弯中越敢持续打方向
...
#define OUTSIDE_FF_SUPPRESS              0.78f
...
#define DIFF_STEP_BASE                   15.0f
#define DIFF_STEP_CURVE_ADD              10.0f
...
void control_loop(void)
{
    ...
    {
        curve_intensity = clamp_f(curve_intensity + 0.14f, 0.0f, 1.0f);
    }
