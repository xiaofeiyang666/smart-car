...
extern uint8 camera_ring_state;
extern uint8 camera_ring_score;
extern uint8 camera_ring_far_score;
extern uint8 camera_ring_near_score;
extern int8 camera_ring_entry_dir_debug;
extern uint8 camera_ring_gate_state_debug;
