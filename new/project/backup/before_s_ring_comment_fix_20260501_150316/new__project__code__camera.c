...
#define CAMERA_RING_ENTER_FRAMES         34
#define CAMERA_RING_INSIDE_FRAMES        58
#define CAMERA_RING_EXIT_FRAMES          30
#define CAMERA_RING_MIN_CONF             38
#define CAMERA_RING_WIDTH_OPEN_ADD       18
#define CAMERA_RING_OPEN_BIAS_TH         10
#define CAMERA_RING_MID_BIAS_MIN         5
#define CAMERA_RING_MID_BIAS_MAX         13
#define CAMERA_RING_PREVIEW_BIAS         10
...
void image_deal(void)
{
    ...
    {
        if ((camera_confidence >= CAMERA_RING_MIN_CONF) &&
            (left_open_hits >= CAMERA_RING_OPEN_HITS_TH) &&
        ...
        else if ((camera_confidence >= CAMERA_RING_MIN_CONF) &&
                 (right_open_hits >= CAMERA_RING_OPEN_HITS_TH) &&
