...
#define RING_FF_LIMIT_ADD                0.8f
#define RING_STEP_MUL                    0.90f
#define RING_SPEED_KEEP_ENTER            0.76f
#define RING_SPEED_KEEP_INSIDE           0.68f
#define RING_SPEED_KEEP_EXIT             0.74f
