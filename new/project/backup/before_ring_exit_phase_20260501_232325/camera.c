...
#define CAMERA_RING_EXIT_YAW_READY       300
#define CAMERA_RING_EXIT_YAW_DONE        355
#define CAMERA_RING_EXIT_YAW_FORCE_DONE  420
...
#define CAMERA_RING_EXIT_VIRTUAL_BIAS    10
...
uint8 find_mid_line_weight(void)
{
    ...
    if ((ring_state_tmp != CAMERA_RING_NONE) && (ring_dir_tmp != 0))
    {
        ...
        {
            ring_virtual_bias_tmp = -ring_dir_tmp * CAMERA_RING_EXIT_VIRTUAL_BIAS;
        }
    ...
    if ((ring_state_tmp != CAMERA_RING_NONE) && (ring_dir_tmp != 0))
    {
        if (ring_state_tmp == CAMERA_RING_EXIT)
        {
            preview_tmp = -ring_dir_tmp * CAMERA_RING_EXIT_PREVIEW_BIAS;
        }
        else
        {
