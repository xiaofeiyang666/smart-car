...
#define RING_FF_LIMIT_ADD                1.8f
#define RING_STEP_MUL                    1.32f
#define RING_SPEED_KEEP_ENTER            0.58f
#define RING_SPEED_KEEP_INSIDE           0.56f
#define RING_SPEED_KEEP_EXIT             0.66f
#define RING_DIFF_MUL                    0.88f
#define RING_EXIT_HEAD_KEEP              0.78f
#define RING_PREPARE_SPEED_KEEP          0.58f
...
void control_loop(void)
{
    ...
    s_transition_line = 0;
    if (!ring_active && ((straight_lock == 0) || (abs_far_preview >= S_TRANSITION_LOCK_BREAK_FAR_TH)) &&
