...
#define CAMERA_TRACK_STRAIGHT       0
#define CAMERA_TRACK_SMALL_CURVE    1
#define CAMERA_TRACK_CURVE          2
#define CAMERA_TRACK_S_TRANS        3
#define CAMERA_TRACK_LOW_CONF       4
...
extern int16 camera_slope_raw;
extern int16 camera_curve_raw;
extern uint8 camera_quality;
extern uint8 camera_track_mode;
