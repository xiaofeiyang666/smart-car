...
#define CAMERA_S_TRANS_FAR_TH            10
#define CAMERA_S_TRANS_NEAR_MAX          34
#define CAMERA_S_TRANS_CONF_MIN          12
#define CAMERA_S_TRANS_BIAS_MAX          12
#define CAMERA_S_TRANS_PREVIEW_BIAS      16
...
uint8 find_mid_line_weight(void)
{
    ...
    racing_bias = 0;
    s_transition = 0;
    if ((camera_confidence >= CAMERA_S_TRANS_CONF_MIN) &&
